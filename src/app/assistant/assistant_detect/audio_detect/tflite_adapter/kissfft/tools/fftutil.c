...
void fft_file(FILE * fin,FILE * fout,int nfft,int isinverse)
{
    ...
    buf = (kiss_fft_cpx*)KISS_FFT_MALLOC(sizeof(kiss_fft_cpx) * nfft );
    bufout = (kiss_fft_cpx*)KISS_FFT_MALLOC(sizeof(kiss_fft_cpx) * nfft );
...
void fft_filend(FILE * fin,FILE * fout,int *dims,int ndims,int isinverse)
{
    ...
    buf = (kiss_fft_cpx *) KISS_FFT_MALLOC (sizeof (kiss_fft_cpx) * dimprod);
...
void fft_filend_real(FILE * fin,FILE * fout,int *dims,int ndims,int isinverse)
{
    ...
    ibuf = KISS_FFT_MALLOC(insize*sizeof(kiss_fft_scalar));
    obuf = KISS_FFT_MALLOC(outsize*sizeof(kiss_fft_scalar));
